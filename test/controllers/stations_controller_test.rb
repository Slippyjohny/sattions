...
class StationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post stations_url, params: { station: { adress: @station.adress, phone: @station.phone, timetable_id: @station.timetable_id } }
    end
  ...
  test "should update station" do
    patch station_url(@station), params: { station: { adress: @station.adress, phone: @station.phone, timetable_id: @station.timetable_id } }
