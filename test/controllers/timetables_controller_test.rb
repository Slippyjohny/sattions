...
class TimetablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create timetable" do
    assert_difference('Timetable.count') do
      post timetables_url, params: { timetable: { arrival_time: @timetable.arrival_time, departure_time: @timetable.departure_time, station: @timetable.station } }
    end
  ...
  test "should update timetable" do
    patch timetable_url(@timetable), params: { timetable: { arrival_time: @timetable.arrival_time, departure_time: @timetable.departure_time, station: @timetable.station } }
