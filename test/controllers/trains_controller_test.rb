...
class TrainsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create train" do
    assert_difference('Train.count') do
      post trains_url, params: { train: { name: @train.name, timetable_id: @train.timetable_id } }
    end
  ...
  test "should update train" do
    patch train_url(@train), params: { train: { name: @train.name, timetable_id: @train.timetable_id } }
